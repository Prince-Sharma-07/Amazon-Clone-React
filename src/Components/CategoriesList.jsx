...
export default function CategoriesList() {
    ...
    return (
        <div className={`bg-[#232f3e] fixed max-md:h-8 max-md:top-12 md:top-15 z-10 w-full flex text-nowrap max-md:gap-2 md:gap-3 overflow-auto font-amazonEmber max-md:px-0 md:px-4 `} >
            <Slidebar toggleSlideBar={toggleSlideBar} handleHamburger={handleHamburger}/>
            <div className={`${borderStyles} text-white max-md:text-xs md:text-sm flex items-center px-1 py-1`} onClick={()=>handleHamburger()}><img src={Hamburger}/>All</div>
