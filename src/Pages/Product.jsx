  ...
  return (
    ...
    <div className='flex flex-col w-full h-auto overflow-auto gap-2'>
      ...
      <div className='flex justify-between w-[100%] px-6 gap-4 relative top-[120px] font-amazonEmber text-[#0f1111]'>
        ...
        <div className='w-[45%] '><img src={img_link} alt="product_image" className='h-150 w-full object-contain' />
        </div>
        ...
        <div className='w-[55%] flex overflow-auto scrollbar-hidden'>
          ...
          <div>
            ...
            <span className='text-[#cc0c39] text-[24px]  flex gap-2'>{discount_percentage}
          ...
          <label className='flex items-center text-[13px] font-[400] bg-[#E3E6E6] px-2 rounded-md border-[1px] border-[#ced4d4]'>Quantity: <select name="" id="" className='p-[6px] px-[9px] w-full'>
          ...
          <button className='p-[6px] px-[9px] border-none text-[13px] font-[400] text-[#0f1111] cursor-pointer bg-[#FFD814] hover:bg-[#FFCE12] rounded-2xl'>Add to cart</button>
